...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $url = 'http://21339de0-85d7-4708-a0f6-404d0b59524b.southcentralus.azurecontainer.io/prever_evasao';  // Use a URL correta da sua API Python
    $options = [
        'http' => [
    ...
    // Agora, você pode exibir $status_evasao ou realizar outras ações com base na previsão.
}
?>
